      ...
      <main className="relative mx-auto flex max-w-7xl flex-col gap-14 px-6 py-16 lg:px-10">
        <header className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-slate-300">
            Explore accessible, framework-agnostic building blocks that drop straight into your
            design system. Swap styling strategies, customise suggestion experiences, and ship
            polished UX in minutes.
          </p>
