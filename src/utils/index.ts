...
export { flattenSuggestionRenderEntries } from './flattenSuggestions'
export { default as getEndOfLastMention } from './getEndOfLastMention'
export { default as getMentionsAndPlainText } from './getMentionsAndPlainText'
...
export { default as mapPlainTextIndex, mapPlainTextIndices } from './mapPlainTextIndex'
